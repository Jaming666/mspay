...
import { detailcount } from "src/api/navigateToout";
...
<template>
  <div class="pd-20">
    ...
    <div class="white-card-row">
      ...
      <div class="item">
        <div>
          出库种类 <test style="font-size: 12px; margin-left: 5px">(应出)</test>
        </div>
    ...
    <div class="white-card-row" style="margin-top: 10px">
      ...
      <div class="item">
        <div>
          出库种类 <test style="font-size: 12px; margin-left: 5px">(实出)</test>
        </div>
        <div>{{ sumNum2 }}</div>
      </div>
    </div>
