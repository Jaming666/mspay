...
const handleQuery = async () => {
  ...
  const res = await getList({
    ...props.condition,
    receiptOrderStatus: props.receiptOrderStatus,
...
const goDetail = (data) => {
  ...
  Taro.navigateTo({
    url: `/in/pages/baseInfo/index?id=${data.id}&type=${data.receiptOrderType}&orderNo=${data.receiptOrderNo}&status=${data.receiptOrderStatus}&name=${data.createByName}&time=${data.createTime}`,
  })
}
